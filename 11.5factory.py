...
def generate_platform_package_v112(project, platform_name, quiet=False):
    """
    v11.2 platform package generator. Gumroad receives a dedicated asset
...
# Override the active generator so v11.2 is the last/authoritative definition.
